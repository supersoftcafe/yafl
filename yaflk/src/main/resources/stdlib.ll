...
define internal %object* @create_object(%size_t %p0, %vtable* %p1) noinline {
...
define internal void @delete_object(%size_t %p0, %object* %p1) noinline {
...
define internal void @releaseActual(%object* %p0) alwaysinline {
