...
void test_object_virtual_function() {
    ...
    obj->parent.vtable = &vtable.v;
    obj->call_count1 = 0;
    obj->call_count2 = 0;
    obj->call_count3 = 0;

    func_t func1 = object_vlookup(&obj->parent, FUNC1_ID);
    func_t func2 = object_vlookup(&obj->parent, FUNC2_ID);
    func_t func3 = object_vlookup(&obj->parent, FUNC3_ID);
